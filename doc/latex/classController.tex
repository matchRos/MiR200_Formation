...
link \hyperlink{classController}{Controller} to it\textquotesingle{}s odom input topic \textquotesingle{}topic\+\_\+name\textquotesingle{}Name of the topic the \hyperlink{classController}{Controller} reads its oddom from \index{Controller@{Controller}!link\+\_\+output\+\_\+control\+\_\+data@{link\+\_\+output\+\_\+control\+\_\+data}}
...
link \hyperlink{classController}{Controller} to it\textquotesingle{}s control difference topic \textquotesingle{}topic\+\_\+name\textquotesingle{} Name of the topic the \hyperlink{classController}{Controller} writes its control difference to \index{Controller@{Controller}!link\+\_\+output\+\_\+state@{link\+\_\+output\+\_\+state}}
...
link \hyperlink{classController}{Controller} to it\textquotesingle{}s state topic \textquotesingle{}topic\+\_\+name\textquotesingle{} Name of the topic the \hyperlink{classController}{Controller} writes its state to \index{Controller@{Controller}!link\+\_\+output\+\_\+velocity@{link\+\_\+output\+\_\+velocity}}
...
link \hyperlink{classController}{Controller} to it\textquotesingle{}s output topic \textquotesingle{}topic\+\_\+name\textquotesingle{}Name of the topic the \hyperlink{classController}{Controller} writes its output to \index{Controller@{Controller}!link\+\_\+target\+\_\+odometry@{link\+\_\+target\+\_\+odometry}}
...
link \hyperlink{classController}{Controller} to it\textquotesingle{}s target odometry topic (combines target state and target velocity) \textquotesingle{}topic\+\_\+name\textquotesingle{} Name of the topic the \hyperlink{classController}{Controller} gets its target state from \index{Controller@{Controller}!link\+\_\+target\+\_\+state@{link\+\_\+target\+\_\+state}}
...
link \hyperlink{classController}{Controller} to it\textquotesingle{}s state topic \textquotesingle{}topic\+\_\+name\textquotesingle{} Name of the topic the \hyperlink{classController}{Controller} gets its target state from \index{Controller@{Controller}!link\+\_\+target\+\_\+velocity@{link\+\_\+target\+\_\+velocity}}
...
link \hyperlink{classController}{Controller} to it\textquotesingle{}s input topic \textquotesingle{}topic\+\_\+name\textquotesingle{}\+: Name of tjhe topic the \hyperlink{classController}{Controller} gets input from \index{Controller@{Controller}!set\+\_\+lyapunov@{set\+\_\+lyapunov}}
...
Setting parameters for the lyapunov control law param param\+: struct that hold the parameters for the law\+: kx,ky,ktheta,omega,v in that order \index{Controller@{Controller}!set\+\_\+lyapunov@{set\+\_\+lyapunov}}
\index{set\+\_\+lyapunov@{set\+\_\+lyapunov}!Controller@{Controller}}
...
Setting parameters for the lyapunov control law param param\+: std\+::vector that hold the parameters for the law\+: kx,ky,ktheta,omega,v in that order \index{Controller@{Controller}!set\+\_\+name@{set\+\_\+name}}
...
Initialise the coordinate system of the \hyperlink{classController}{Controller} to position param\+: vector$<$double$>$ coord\+: Position vector \index{Controller@{Controller}!set\+\_\+type@{set\+\_\+type}}
...
Set the type of the controllaw param\+: type\+: Controllaw type (see \hyperlink{classController_a86221d052db839985bd6e4d73013cd06}{Controller\+::controller\+Type}) \index{Controller@{Controller}!set\+\_\+world\+\_\+frame@{set\+\_\+world\+\_\+frame}}
...
Set the name of the reference/world frame param\+: frame \+: Name of the frame in tf tree 

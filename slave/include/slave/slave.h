...
class Slave{
    public:
        ...
        ///link slave to it's odom input topic
        ///'topic_name'Name of the topic the slave reads its oddom from                       
    ...
    protected:
        ...
        geometry_msgs::Pose current_pose;                       //Pose of slave at the moment

...
experiment_name=$1
data_source='/media/malte/3E0CFF1E0CFECFBF/tmp'
config_source='/home/malte/match/src/multi_robot_system/multi_robot_launcher/config'
path_target='/media/malte/3E0CFF1E0CFECFBF/simulation'

# # rm $data_source/*
# sleep 3
# roslaunch multi_robot_launcher gazebo.launch world_name:=/home/malte/match/src/multi_robot_system/multi_robot_launcher/worlds/empty_world_camera.world &
# sleep 5
